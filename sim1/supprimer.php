...
<script>
function clik(){
w = Dialog.confirm('Confirmez vous la suppression ???', 
               {width:300, okLabel: 'OUI', cancelLabel: 'NON',
               id: 'myDialogId',
...
<th><a href="supprimer_success.php?id=<?php echo ''.$row['mat'].'';?>" onclick="clik();">Supprimer</a></th>
