...
/*on fait la somme */
$sql = mysql_query("SELECT SUM(".$mois1.") AS total FROM eleves WHERE classe='TG'");
...
$req= mysql_query("SELECT mat FROM eleves where classe='TG'");
...
<tr style="text-align: center;"><th><?php echo "TG" ?></th>
