...
/*on fait la somme */
$sql = mysql_query("SELECT SUM(".$mois1.") AS total FROM eleves WHERE classe='2ndeS'");
...
$req= mysql_query("SELECT mat FROM eleves where classe='2ndeS'");
...
<tr style="text-align: center;"><th><?php echo "2ndeS" ?></th>
