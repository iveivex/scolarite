...
/*on fait la somme */
$sql = mysql_query("SELECT SUM(".$mois1.") AS total FROM eleves WHERE classe='TL1'");
...
$req= mysql_query("SELECT mat FROM eleves where classe='TL1'");
...
<tr style="text-align: center;"><th><?php echo "TL1" ?></th>
