...
/*on fait la somme */
$sql = mysql_query("SELECT SUM(".$mois1.") AS total FROM eleves WHERE classe='TL2'");
...
$req= mysql_query("SELECT mat FROM eleves where classe='TL2'");
...
<tr style="text-align: center;"><th><?php echo "TL2" ?></th>
