...
/*on fait la somme */
$sql = mysql_query("SELECT SUM(".$mois1.") AS total FROM eleves WHERE classe='2ndeL'");
...
$req= mysql_query("SELECT mat FROM eleves where classe='2ndeL'");
...
<tr style="text-align: center;"><th><?php echo "2ndeL" ?></th>
