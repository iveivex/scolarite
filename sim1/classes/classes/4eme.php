...
/*on fait la somme */
$sql = mysql_query("SELECT SUM(".$mois1.") AS total FROM eleves WHERE classe='4eme'");
...
$req= mysql_query("SELECT mat FROM eleves where classe='4eme'");
...
<tr style="text-align: center;"><th><?php echo "4eme" ?></th>
