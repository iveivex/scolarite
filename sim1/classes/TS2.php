...
/*on fait la somme */
$sql = mysql_query("SELECT SUM(".$mois1.") AS total FROM eleves WHERE classe='TS2'");
...
$req= mysql_query("SELECT mat FROM eleves where classe='TS2'");
...
<tr style="text-align: center;"><th><?php echo "TS2" ?></th>
