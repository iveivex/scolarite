...
/*on fait la somme */
$sql = mysql_query("SELECT SUM(".$mois1.") AS total FROM eleves WHERE classe='TS1'");
...
$req= mysql_query("SELECT mat FROM eleves where classe='TS1'");
...
<tr style="text-align: center;"><th><?php echo "TS1" ?></th>
