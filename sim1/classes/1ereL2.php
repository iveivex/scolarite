...
/*on fait la somme */
$sql = mysql_query("SELECT SUM(".$mois1.") AS total FROM eleves WHERE classe='1ereL2'");
...
$req= mysql_query("SELECT mat FROM eleves where classe='1ereL2'");
...
<tr style="text-align: center;"><th><?php echo "1ereL2" ?></th>
