...
<?php include('menu.php');?>
	...
	<div style=" text-align:center; text-transform: uppercase; font-size: large;">
	       ...
	       <a href="impaye_ttlesmois.php#Octobre" class="submit">Octobre</a>&nbsp;&nbsp;
	       <a href="impaye_ttlesmois.php#Novembre" class="submit">Novembre</a>&nbsp;&nbsp;
	       <a href="impaye_ttlesmois.php#Decembre" class="submit">Decembre</a>&nbsp;&nbsp;
	       <a href="impaye_ttlesmois.php#Janvier" class="submit">Janvier</a>&nbsp;&nbsp;
	       <a href="impaye_ttlesmois.php#Fevrier" class="submit">Fevrier</a>&nbsp;&nbsp;
	       <a href="impaye_ttlesmois.php#Mars" class="submit">Mars</a>&nbsp;&nbsp;
	       <a href="impaye_ttlesmois.php#Avril" class="submit">Avril</a>&nbsp;&nbsp;
	       <a href="impaye_ttlesmois.php#Mai" class="submit">Mai</a>&nbsp;&nbsp;
	       <a href="impaye_ttlesmois.php#Juin" class="submit">Juin</a>&nbsp;&nbsp;
	       <a href="impaye_ttlesmois.php#Juillet" class="submit">Juillet</a>&nbsp;&nbsp;
	
	</div>
	<br />
	<hr />
	<a href="specifier_impaye.php">Retourner</a>
...
$req=mysql_query("SELECT * FROM eleves WHERE Octobre ='non' ORDER BY classe DESC") or die ('Erreur requete');
$req1=mysql_query("SELECT * FROM eleves WHERE Novembre ='non' ORDER BY classe DESC") or die ('Erreur requete');
$req2=mysql_query("SELECT * FROM eleves WHERE Decembre ='non' ORDER BY classe DESC") or die ('Erreur requete');
$req3=mysql_query("SELECT * FROM eleves WHERE Janvier ='non' ORDER BY classe DESC") or die ('Erreur requete');
$req4=mysql_query("SELECT * FROM eleves WHERE Fevrier ='non' ORDER BY classe DESC") or die ('Erreur requete');
$req5=mysql_query("SELECT * FROM eleves WHERE Mars ='non' ORDER BY classe DESC") or die ('Erreur requete');
$req6=mysql_query("SELECT * FROM eleves WHERE Avril ='non' ORDER BY classe DESC") or die ('Erreur requete');
$req7=mysql_query("SELECT * FROM eleves WHERE Mai ='non' ORDER BY classe DESC") or die ('Erreur requete');
$req8=mysql_query("SELECT * FROM eleves WHERE Juin ='non' ORDER BY classe DESC") or die ('Erreur requete');
$req9=mysql_query("SELECT * FROM eleves WHERE Juillet ='non' ORDER BY classe DESC") or die ('Erreur requete');
?>
